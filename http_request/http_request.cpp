...
QByteArray http_request::get( QNetworkProxy::ProxyType proxy_type, QString proxy_ip, QString proxy_port, QString url, QMap<QString, QString> data)
{
    QNetworkProxy proxy;
...
QByteArray http_request::post(QNetworkProxy::ProxyType proxy_type, QString proxy_ip, QString proxy_port, QString url, QMap<QString, QString> data)
{
    QNetworkProxy proxy;
    proxy.setType( proxy_type );
    proxy.setHostName( proxy_ip );
